...
export class AddSuspiciousActivitiesTable1736272929422 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "suspicious_activities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."suspicious_activities_type_enum" NOT NULL, "details" json, "resolve_token" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "resolved_at" TIMESTAMP WITH TIME ZONE, "user_id" uuid NOT NULL, "session_id" uuid, CONSTRAINT "UQ_b258d5f9dfb8ff9b6d42723daea" UNIQUE ("resolve_token"), CONSTRAINT "PK_c03f5576ed92d11f99d98ebf281" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
